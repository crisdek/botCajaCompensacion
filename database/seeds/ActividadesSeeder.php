...
class ActividadesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        App\Actividad::create(['grupo_interes_id' => 7, 'nombre' => 'Word avanzado', 'descripcion' => 'Está actividad pretende profundizar en ...', 'fecha' => '2018-10-14', 'duracion' => '60', 'costo' => '90000', 'estado' => 'P']);
    }
}
